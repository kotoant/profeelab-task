...
public class AccountResource {
     ...
     */
    @Timed(value = "http.request", extraTags = {"uri", "/accounts/create"})
    @POST
    @Path("/create")
     ...
     */
    @Timed(value = "http.request", extraTags = {"uri", "/accounts/{accountId}"})
    @GET
    @Path("/{accountId}")
     ...
     */
    @Timed(value = "http.request", extraTags = {"uri", "/accounts/transfer"})
    @POST
    @Path("/transfer")
